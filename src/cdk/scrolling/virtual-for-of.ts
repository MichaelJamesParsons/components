...
import {RecycleViewRepeaterStrategy, VIEW_REPEATER_STRATEGY, ViewRepeaterItemInsertArgs} from '@angular/cdk/view';
...
export class CdkVirtualForOf<T> implements CollectionViewer, DoCheck, OnDestroy {
  ...
  set cdkVirtualForTemplateCacheSize(size: number|string) {
    this._viewRepeater.templateCacheSize = coerceNumberProperty(size);
  }

  get cdkVirtualForTemplateCacheSize() {
    return this._viewRepeater.templateCacheSize;
  }
  ...
  constructor(
      ...
      @Inject(VIEW_REPEATER_STRATEGY) private _viewRepeater: RecycleViewRepeaterStrategy<T, T, CdkVirtualForOfContext<T>>,
  ...
  private _getEmbedArgsForItem(record: IterableChangeRecord<T>, index: number): ViewRepeaterItemInsertArgs<CdkVirtualForOfContext<T>> {
